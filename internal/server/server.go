...
import (
	...
	"github.com/nextxm/paisa/internal/model/template"
	...
	"github.com/nextxm/paisa/internal/server/liabilities"
	"github.com/nextxm/paisa/internal/utils"
	"github.com/nextxm/paisa/web"
...
func Build(db *gorm.DB, enableCompression bool) *gin.Engine {
	...
	router.GET("/api/price/filters", func(c *gin.Context) {
